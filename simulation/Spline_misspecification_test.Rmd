---
title: "Spline misspecification test"
author: "Junting Ren"
date: "8/31/2020"
...
MCMCfit1<-Bayesian_Semi_probit(Z,X,G,K=K_model,nIter,burnIn,thin, 
                               ...
                               alpha_prior_var = 2.5, gamma_prior_var=2.5, step_thres = 0.2)
```
...
```{r}
(g2 = positive_sim_plot_probit(x =c(1,3 ,0), Alpha, est_Alpha, phi.mat.true = phi.mat,phi.mat.model = MCMCfit$Bden_raw, byStep = byStep,
                  MCMCfit = MCMCfit, last_n = last_n, true_thres = thres, est_thres = est_thres))
...
#ggsave(filename = "../figures/individual",device = "jpg",plot = plot_individual,
#       width = 6, height = 5, dpi =800)
```
