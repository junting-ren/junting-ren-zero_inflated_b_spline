...
dat_name = paste(folder_path, "compare_gamma", "n=",n,"_","K_model = ",K_model ,"_", Sys.Date(), ".RData", sep = "")
table_name = paste(folder_path, "table_compare_gamma", "n=",n,"_", "K_model = ",K_model ,"_", Sys.Date(), ".csv", sep = "")
```
