...
(g = positive_sim_plot(x =c(1, 1,1 ), Alpha, est_Alpha, phi.mat.true = phi.mat,phi.mat.model = MCMCfit$Bden_raw, byStep = byStep, 
                  MCMCfit = MCMCfit, last_n = last_n))
ggsave(filename = "../figures/population",device = "jpg",plot = g[[1]],
...
```{r}
save.image(file = "figure1_R_image.Rdata")
```
